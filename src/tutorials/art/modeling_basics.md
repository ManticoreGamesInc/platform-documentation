...
Try adding your own garnishes using the techniques we used to make the pancakes. Maybe some orange wedges or a side of hash browns? Share your creation on on the `#showcase` channel in CORE's :fab fa-discord: [Creator Discord](/discord/) so others can see what you made!
