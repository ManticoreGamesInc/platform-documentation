...
!!! info
    It is important that the vehicle does not overlap the **Spawn Point**, otherwise there will be collision issues.

![Searching Core Content for Four Wheeled Vehicle](../img/Vehicles/SearchingCoreContentForFourWheeledVehicle.png)

### Find and Add a Prop Vehicle to the Orange Sedan

1. Find any vehicle in **Core Content** or **Community Content** that you wish to transform into a functioning vehicle. For this tutorial, the prop of choice is "**Urban Car - Sedan 01 (Prop)**".
2. Hold left-click on the prop vehicle you wish to transform and drag it into the **ClientContext** within the **Orange Sedan**.
...
![Searching Core Content for Urban Sedan](../img/Vehicles/SearchingCoreContentForUrbanSedan.png)

![Prop in Orange Sedan](../img/Vehicles/PropInOrangeSedan.png)
...
![Deinstance Prop Vehicle](../img/Vehicles/DeinstancePropVehicle.png)
...
![Orange Sedan Wheels Properties Filled](../img/Vehicles/OrangeSedanWheelsPropertiesFilled.png)
...
![Editing Radius and Width and Offset for Each Wheel](../img/Vehicles/EditingRadiusAndWidthAndOffsetForEachWheel.png)
