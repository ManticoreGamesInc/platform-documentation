...
!!! note
    ...
    [Learn more about Rotations on the Core API](../api/index.md#rotation) page.
...
- `World` is a [collection of functions](../api/index.md#world) for finding objects in the world.
