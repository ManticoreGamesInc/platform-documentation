...
| `brakingDecelerationWalking` | Number | Deceleration when walking and movement input has stopped. Default = 1800. | Read-Write |
...
| `jumpVelocity` | Number | Vertical speed applied to Player when they jump.  Default is 900 | Read-Write |
