...
| `actionBinding` | string | Which action binding will cause the Ability to activate. Possible values are listed on the [Ability binding](api/ability_bindings.md) list. | Read-Only |
