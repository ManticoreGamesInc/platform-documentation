...
| `animationEvent`             | Event&lt;Player>,EventName                   | Event fired during certain animations. Client only.                                                                                                                                                                                                                                                            | Client Context             |
...
| Class Function                                                               | Return Type  | Description                                                         | Tags |
| ---------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------- | ---- |
| `Spawn(string childTemplateId, Vector3 startPosition, Vector3 direction)`    | Projectile   | Spawns a Projectile with a child that is an instance of a template. | None |
...
| `CoreDebug.DrawSphere(Vector3 center, radius, [table optionalParameters])`          | Vector3      | Draw a debug sphere.                                                                                                                                                          | None |
...
| Event            | Return Type        | Description                                                                                                                                | Tags      |
| ---------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | --------- |
| `clickedEvent`   | Event&lt;UIButton> | Called when button is clicked. This triggers on mouse-button up, if both button-down and button-up events happen inside the button hitbox. | Read-Only |
| `pressedEvent`   | Event&lt;UIButton> | Called when button is pressed (mouse button down).                                                                                         | Read-Only |
| `releasedEvent`  | Event&lt;UIButton> | Called when button is released (mouse button up).                                                                                          | Read-Only |
| `hoveredEvent`   | Event&lt;UIButton> | Called when button is hovered.                                                                                                             | Read-Only |
| `unhoveredEvent` | Event&lt;UIButton> | Called when button is unhovered.                                                                                                           | Read-Only |
...
| `FindObjectsByType(string typeName)`                            | array&lt;CoreObject> | Returns a table containing all the objects in the hierarchy whose type is or extends the specified type.  If none match, an empty table is returned.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | None |
| `FindObjectByName(string typeName)`                             | CoreObject           | Returns the first object found with a matching name. In none match, nil is returned.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | None |
| `FindObjectById(string muidString)`                             | CoreObject           | Returns the object with a given MUID.  Returns nil if no object has this ID.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | None |
