...
| ----- | ----------- | ----------- | ---- |
| `equippedEvent` | [`Event`](event.md)<[`Equipment`](equipment.md) equipment, [`Player`](player.md) player> | Fired when this equipment is equipped onto a player. | None |
| `unequippedEvent` | [`Event`](event.md)<[`Equipment`](equipment.md) equipment, [`Player`](player.md) player> | Fired when this object is unequipped from a player. | None |
