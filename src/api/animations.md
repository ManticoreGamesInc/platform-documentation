...
| `unarmed_magic_bolt` | Magic casting animation which appears to launch a projectile forward from the hands. | This animation supports a variable cast time. |
| `unarmed_punch_left` | A left punch animation. | This animation supports a variable cast time. |
| `unarmed_punch_right` | A right punch animation. | This animation supports a variable cast time. |
