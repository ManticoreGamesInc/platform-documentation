...
- **Check out the [Getting Started](https://www.coregames.com/docs/getting_started/editor_intro/) section of the [CORE Creator Hub](https://www.coregames.com/docs/)** - Here you'll find an overview of the editor, a tutorial on making your first game, and how to share and use shared content within CORE
>>>>>>> 999615f37d4656a5caef96606ddc42d613c1e261
...
> **Q:** Will stuff like the built in chat be editable for users? like if someone wanted to change something about it for their specific game?
>
> **A:** In-game text chat will happen sometime during Alpha. We won't have voice chat to start but we can of course use discord!

Join the CORE Alpha :fab fa-discord: [Discord Server](https://discord.gg/85k8A7V)

## CORE Content

> **Q:** One thing I'm unclear on, are the things made in CORE meant to stay within the confines of the community content, or can it build to other platforms as well?
>
> **A:** Stuff made in CORE is meant to be used on the CORE platform, but 100% sharable across the platform if you so desire. In my stream on monday I will show off how easy it is to copy/paste content from one game to another….
>
> Want the helicopters from Sniper Alley in Spellshock? Crtl-C, Ctrl-V, done!
...
> so not only is this a cool set-piece, it comes with the scripts needed to make it function
>
> And don't worry - we have yet to find anything that cannot be made in core using this methodc even all our Guns in our shooter games are made from 'gun parts' so you can totally make your own weapons if you want to
...
> **Q:** Does the Lua scripting system support use of external editors?
>
> **A:** Yes we support external editors for Lua  We have a built-in stack frame debugger that allows you to set breakpoints, step into and over functions, and inspect variables
>
> Here is a screenshot of the built-in Lua debugger. I've paused execution and I am inspecting the script that handles zooming in my scope on the client - Don't worry if you are not a coder, you won't have to go this deep to make stuff in CORE - but if you want to, you can. That is what we mean by "opt-in complexity"
...
>
> **Q:** Do I have to use player CORE avatars?
> **A:** No you can change the avatar representation [more info]
...
> **Q:** Does the engine support real-time audio effects? For example, applying reverb to an audio listener when a character enters a large room.
>
> **A:** Yes, You can also dynamically adjust lots of things on audio clips besides normal post-effects. - our Audio guru is awesome, and he even made Music Construction Kits so you can dynamically adjust music and build up your own tracks from his pieces - I will show that off today in my stream with the Pirate music
>
> I have a script that dynamically sets volumes on the instruments at different times
>
>  And just like with our 3D objects and Materials, you can also 'kitbash' audio to do things it wasn't nesc. intended to do
>
> For instance, I wanted a creaking windmill sound - but I found if i pitched the wooden door opening sound down about 3 octaves and looped it it made a great creaky windmill
...
>
> **A:** Hopefully not that huge (though that's like how big RDR2 was right? lol). I think currently it's a few gigs, maybe 3 at the most?
...
>
> The one 'gotcha' right now is that you don't want your .git folder to be inside each individual map folder, as currently CORE doesn't ignore it and copies it everywhere, which gets big...
>
> So, you want to do one of two things.... make a repro of your entire maps folder, with each game as a subfolder -OR-  make a repro for each game, and put the actual project 1 level deeper however, we will be fixing this during alpha
...
> **Q:** so i noticed in the system reqs it says you need a "NVIDIA GeForce GTX 1050 Ti or AMD equivalent" is it possible to use core without a fancy GPU like this?
>
> **A:** The specs for Alpha are likely higher than they will be for launch, as we haven't done all our optimizations yet
> our VFX artist was working on a 900 series card for most of the project
>>>>>>> 999615f37d4656a5caef96606ddc42d613c1e261
